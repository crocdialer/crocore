...
void send_udp_broadcast(const std::vector<uint8_t> &bytes, int port);
...
public:
    ...
    void set_tcp_receive_cb(tcp_receive_cb_t f = tcp_receive_cb_t());
    ...
    void set_timeout(double the_timeout_secs);
