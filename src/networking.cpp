...
namespace crocore{ namespace net {
              ...
              const std::string &ip_string, int port)
{
    try
    {
        ...
        udp::resolver::query query(udp::v4(), ip_string, crocore::to_string(port));
                                          ...
                                          tcp_receive_cb_t f)
{
    ...
    resolver_ptr->async_resolve({the_ip, crocore::to_string(the_port)},
